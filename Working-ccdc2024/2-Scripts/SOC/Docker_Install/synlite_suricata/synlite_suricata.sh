...
export SYNLITE_SURICATA_DICT_PATH=/usr/share/logstash/synlite_suricata/dictionaries
export SYNLITE_SURICATA_TEMPLATE_PATH=/usr/share/logstash/synlite_suricata/templates
export SYNLITE_SURICATA_GEOIP_DB_PATH=/usr/share/logstash/synlite_suricata/geoipdbs
...
export SYNLITE_SURICATA_ES_USER=elastic
export SYNLITE_SURICATA_ES_PASSWD=changeme
